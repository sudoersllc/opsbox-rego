...
class Config(BaseModel):
    connections_firewalled_upper_bound: Annotated[
        int,
        Field(
            default=2,
            description="Upper bound for firewalled connections.",
        ),
    ]


class HighConnectionsFirewalled:
    """Plugin for identifying Azure DBs with high connections firewalled."""
    ...
    def report_findings(self, data: "Result"):
        ...
        template = """The following Azure SQL dbs have large amounts of requests blocked by the firewall: \n
        {info}"""
        try:
            info = yaml.dump(
    ...
    def inject_data(self, data: "Result") -> "Result":
        ...
        """
        data.details["input"]["connections_firewalled_upper_bound"] = self.conf[
            "connections_firewalled_upper_bound"
        ]
        return data
