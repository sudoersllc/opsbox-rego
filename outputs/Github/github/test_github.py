...
def test_proccess_results_raw(monkeypatch, loguru_caplog):
    ...
    def fake_post(url, **kwargs):
        ...
        if "gists" in url:
            ...
            return FakeResponse(
                201, json_data={"html_url": "https://gist.github.com/fake_gist"}
            )
        elif "repos" in url:
            ...
            return FakeResponse(
                201, json_data={"html_url": "https://github.com/fake_issue"}
            )
        else:
...
def test_proccess_results_create_description_with_embed(monkeypatch, loguru_caplog):
    ...
    monkeypatch.setattr(
        ...
        type(
            ...
            (),
            {"from_documents": staticmethod(fake_from_documents)},
        ),
    )
